"use client" /* Left Column: Massive Editorial Typography */ /* Right Column: Suspended 3D Dashboard Frame */ /* Specular sheen effect on hover */ /* Window Header */ /* Mock Dashboard Preview */ /* Stat Card 1 */ /* Stat Card 2 */ /* Interactive Widget Row */ /* Metric Chart Bar */
...
export const Chapter02Hero: React.FC<Chapter02Props> = ({
  onProceed,
  onPlayClick,
}) => {
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid lg:grid-cols-12 gap-12 items-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full material-glass border border-white/10 text-xs font-mono tracking-widest text-zinc-400">
            ...
            <span>
              <span className="text-white font-extrabold text-sm border-b border-white/40">
                G
              </span>
              RADUATE{" "}
              <span className="text-white font-extrabold text-sm border-b border-white/40">
          ...
          <p className="text-lg md:text-xl text-zinc-400 font-light max-w-lg leading-relaxed">
            InternEdge unifies resume optimization, application auto-sync, AI
            mock interviews, and offer evaluation into one intelligent platform.
          </p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-zinc-400">
                      Apple System Architecture Practice
                    </div>
                  </div>
                </div>
