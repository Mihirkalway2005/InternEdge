"use client" /* Chapter Text Header */ /* Main Tour Showcase Layout */ /* Module Selector Sidebar */ /* Focused Module Deep-Dive Inspection Card */ /* Bullet Points */ /* Bottom Telemetry Bar & Next Step */
...
const modulesList = [
  {
    ...
    subtitle:
      "Instant parsing against real ATS algorithms (Workday, Greenhouse, Lever)",
    icon: FileText,
...
export const Chapter06Tour: React.FC<Chapter06Props> = ({
  onProceed,
  onAudioClick,
}) => {
