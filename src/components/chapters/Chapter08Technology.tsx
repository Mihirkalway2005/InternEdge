"use client" /* Chapter Header */ /* Wireframe Titanium System Architecture Grid */ /* Left Column: Interactive Titanium Nodes */ /* Right Column: Node Technical Blueprint Telemetry Card */
...
export const Chapter08Technology: React.FC<Chapter08Props> = ({
  onProceed,
  onAudioClick,
}) => {
